...
<h2>Reenviar correo de creación de nuevo usuario</h2>

<p>
Por favor introduce a continuación la dirección de correo electrónico con la que hiciste la petición de Nuevo Usuario. Se enviará de nuevo el correo de confirmación. Revisa todas tus carpetas, inclusive la de correo no deseado.
</p>

<form method='post' action='resend_nuevo_usuario2.php'>
  <table>
  <tr>
