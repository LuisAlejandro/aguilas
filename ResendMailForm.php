...
<h2><?= _("Reenviar Correo") ?></h2>

<p><?= _("Por favor introduce a continuación la dirección de correo electrónico con la que hiciste la petición de Nuevo Usuario para reenviar el correo de confirmación.") ?></p>

<form method="post" action="ResendMailDo.php">
    <table>
        <tr>
            <td class="px160">
