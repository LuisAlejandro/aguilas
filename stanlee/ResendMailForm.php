<?php
$allowed_ops = "ResendMailForm";
require_once "./setup/config.php";
require_once "./libraries/Locale.inc.php";
require_once "./themes/$app_theme/header.php";
?>

<h2><?= _("Resend E-Mail") ?></h2>

<p><?= _("Please enter the e-mail you used to register your new user account, so we can resend the confirmation e-mail.") ?></p>
